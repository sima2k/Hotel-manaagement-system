...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active me-2"  aria-current="page" href="CONTACT US.php">Contact</a>
                    </li>
                </ul>
                <div class="d-flex">
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">Here are a few ways to get in touch with us.</p>
    </div>    
                ...
                <div class="bg-white rounded shadow p-4">
                    <iframe class="w-100 rounded mb-4" height="320px" src="<?php echo $contact_r['iframe'] ?>"></iframe>
                        ...
                        <?php
                            if($contact_r['pn2']!=''){
                                echo<<<data
                                    <a href="tel:+$contact_r[pn2]" class="d-inline-block text-decoration-none text-dark mb-2">
                                    <i class="bi bi-telephone-fill"></i>+$contact_r[pn2]
                                    </a>
                                data;
                            }
                        ?>
                        <h5 class="mt-4">Email</h3>
            ...
            <div class="col-lg-6 col-md-6 px-4">
                ...
                <form method="POST">
                    ...
                    <div class="mt-3">
                        ...
                        <input name="name" required type="text" name="name" placeholder="your name" class="form-control shadow-none">
                    </div>
                    <div class="mt-3">
                        <label class="form-label" style="font-weight: 500;">Email</label>
                        <input name="email" required type="email" name="email" placeholder="your email" class="form-control shadow-none">
                    </div>
                    <div class="mt-3">
                        <label class="form-label" style="font-weight: 500;">Subject</label>
                        <input name="subject" required type="text" name="subject" placeholder="your Subject" class="form-control shadow-none">
                    </div>
                    <div class="mt-3">
                        <label class="form-label" style="font-weight: 500;">Message</label>
                        <textarea class="form-control shadow-none" name="message" required rows="5" style="resize: none;" name="message" placeholder="your message...."></textarea>
                    </div>
                            
                    <button type="submit" name="send" class="btn btn-outline-dark text-white custom-bg shadow-none mt-2 ">SEND</button>
                </form>
                </div>
