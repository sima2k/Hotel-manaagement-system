    ...
    <section class="gallery min-vh-100">
        <div class="container-lg">
            <div class="row gy-4 row-cols-1 row-cols-sm-2 row-cols-md-3">
                <div class="col">
                    <img src="image/gallery/1.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
                <div class="col">
                    <img src="image/gallery/2.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
                <div class="col">
                    <img src="image/gallery/3.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
                <div class="col">
                    <img src="image/gallery/4.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
                <div class="col">
                    <img src="image/gallery/5.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
                <div class="col">
                    <img src="image/gallery/6.jpg" class="gallery-item" alt="gallery" height="300px">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="modal fade" id="gallery-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="image/gallery/5.jpg" class="modal-img" alt="modal img" height="400px">
                </div>
            </div>
        </div>
    </div>
